...
const PATH_ICONS: Readonly<Record<string, keyof typeof icons>> = {
  ...
  "/docs/understand/routing": "GitFork",
  ...
  "/docs/elements/signal/once": "ListOrdered",
  "/docs/elements/signal/broadcast": "Share2",
  "/docs/elements/signal/live": "Activity",
  ...
  "/docs/elements/gate/tenancy": "Building",
  ...
  "/docs/elements/channel/whatsapp": "MessageCircle",
  ...
  "/docs/reference": "BookBookmark",
  "/docs/reference/plugins": "Puzzle",
  "/docs/client": "Cable",
  "/docs/client/calling": "Braces",
  "/docs/client/auth": "Lock",
  "/docs/client/live": "Activity",
  "/docs/client/react": "Atom",
...
const PATH_BRANDS: Readonly<Record<string, BrandMarkId>> = {
  ...
  "/docs/recipes/openrouter": "openrouter",
