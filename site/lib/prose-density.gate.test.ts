...
describe("docs prose density", () => {
  test(`index + understand + elements + recipes + providers + client + reference + plugins + ai MDX ≤ ${MAX_CONSECUTIVE} consecutive plain paragraphs`, async () => {
    const files = [
