...
export const ELEMENTS: ReadonlyArray<{
...
}> = [
  {
    ...
    symbol: "Fl",
    essence: "behavior",
    description: "HTTP, Signal, Clock, and CDC — one species.",
  ...
  },
  {
    ...
    symbol: "Ck",
    essence: "time",
    description: "Named cron and intervals, plus durable sleep through fx.",
    replaces: "cron · every · delay · durable sleep · timeout",
  ...
  },
  {
    ...
    description: "Auth, ABAC, scopes, and rate limits at the trigger.",
    replaces: "auth · session · ABAC · scope · rate limit · public",
  ...
  },
  {
    ...
    description: "Models, prompts, embeds, and agents — budgets and allowPii.",
...
export const MANIFEST_INPUTS: ReadonlyArray<{
  ...
  { syntax: "http.post({ in, out }) · call(name, { in, out })", records: "contracts" },
  { syntax: "fx.store · fx.emit · fx.vault.get · fx.ask", records: "effects" },
