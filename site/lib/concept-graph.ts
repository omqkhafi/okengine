...
export const CANONICAL_ELEMENTS = [
  {
    ...
    symbol: "Fl",
    essence: "Behavior",
    summary: "HTTP, Signal, Clock, and CDC triggers — one Flow species.",
  ...
  },
  {
    ...
    summary: "Authentication, RBAC/ABAC, scopes, and rate limits at the trigger.",
  ...
  },
  {
    ...
    summary: "Models, prompts, embeds, and agents — budgets and allowPii.",
