...
/**
 * Discord Clyde — blurple field, white mark. Brand colour is `#5865F2`
 * (Simple Icons / Discord). Same flush-square treatment as {@link NpmMark}:
 * the field is painted in the SVG so the header cell *is* the tile.
 *
 * Scale is tuned so Clyde’s glyph height matches the npm “n” (~0.78 of the
 * 24×24 viewBox). Clyde stays wider than tall (brand proportions); only the
 * height is locked to the sibling mark for optical parity in the header.
 *
 * @param className - Sizing / colour classes
 */
export function DiscordMark({ className }: { className?: string }) {
  return (
    <svg role="img" viewBox="0 0 24 24" className={className} aria-hidden>
      <path fill="#5865F2" d="M0 0h24v24H0z" />
      <path
        fill="#fff"
