...
<Callout title="The one rule">
  Traefik never mounts the raw Docker socket. A filtered `tecnativa/docker-socket-proxy`
  companion exposes only containers / events / ping / version / networks on the internal
  compose network.
</Callout>
...
<Cards>
  ...
  <Card title="PgDog" description="Pool Postgres behind the same stack." href="/docs/images/pgdog" />
  <Card
    title="Redis Cloud"
