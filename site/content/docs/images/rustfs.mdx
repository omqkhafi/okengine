...
<Callout title="The one rule">
  Protocol name is `s3` — vendor choice is the image pin (`rustfs/rustfs:…`) plus
  `S3_ENDPOINT`. Never invent a `rustfs` driver id.
</Callout>
...
<Cards>
  <Card title="Mailpit" description="SMTP catcher for the same stack." href="/docs/images/mailpit" />
