...
Same credential contract as [Postgres](/docs/images/postgres):
...
[Postgres · Production note](/docs/images/postgres#production-note).
...
- [Postgres](/docs/images/postgres) — generic recipe this specialises
...
<Cards>
  <Card title="Postgres" description="Plain Postgres recipe." href="/docs/images/postgres" />
  <Card
    title="Supabase"
    description="Postgres + extension bundle."
    href="/docs/images/supabase-docker"
  />
  <Card title="PgDog" description="Transaction pooling in front." href="/docs/images/pgdog" />
</Cards>
