...
<Callout title="The one rule">
  Docker ≈ prod for the **SMTP protocol** — same `SMTP_URL` shape. Mailpit is not a
  production MTA; swap the image / URL for a real relay when you leave local docker.
</Callout>
...
<Cards>
  <Card title="RustFS" description="S3-compatible files for the same stack." href="/docs/images/rustfs" />
  <Card title="OpenBao" description="Vault recipe for docker/prod secrets." href="/docs/images/openbao" />
