...
- [YugabyteDB](/docs/images/yugabytedb) — Apache-2.0 self-hosted alternative
...
<Cards>
  ...
  />
  <Card title="YugabyteDB" description="Self-hosted YSQL peer." href="/docs/images/yugabytedb" />
