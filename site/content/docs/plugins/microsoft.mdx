...
<Callout title="The one rule">
  Pick the audience first: `tenant: "common"` for everyone, `organizations`
  for work/school only, `consumers` for personal accounts, or a tenant GUID to
  lock sign-in to one directory.
</Callout>
...
**Consequence:** an ID token minted by a *different* tenant fails the issuer
...
<Cards>
  ...
  <Card title="Discord" description="Nullable emails, verified flag." href="/docs/plugins/discord" />
