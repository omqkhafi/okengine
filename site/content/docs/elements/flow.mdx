...
<Cards>
  <Card title="Learn · Notes" description="Full CRUD flows — create, list (cursor + search), get, update, remove." href="/docs/learn/notes" />
  <Card title="Learn · Linkly" description="One file, four triggers — endpoint, consumer, cron, and callable." href="/docs/learn/linkly" />
</Cards>
