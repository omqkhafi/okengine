...
Signal / Clock consumers need an explicit `flow("…")` or a tree stamp. Nameless
`flow({ do })` outside `src/flows/<unit>/` fails **OKE1072** even with `export const`.
Collision is **OKE1070**. HTTP nameless stays for the tree or **OKE1045**.
