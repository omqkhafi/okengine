...
```typescript title="src/flows/uploads/put.ts"
import { on, flow, http } from "okengine";
import { z } from "zod";
import { uploads } from "@/core";

export const putObject = on(
  http.post("/uploads"),
  flow("uploads.put", {
    in: z.object({
      name: z.string().min(1),
...
```typescript title="src/flows/exports/write.ts"
import { on, flow, http } from "okengine";
import { uploads } from "@/core";

export const writeExport = on(
  http.post("/exports"),
  flow("exports.write", {
    do: async (_, fx) => {
...
```typescript title="src/flows/avatars/cleanup.ts"
import { on, flow, http } from "okengine";
import { z } from "zod";
import { uploads } from "@/core";

export const cleanupAvatars = on(
  http.delete("/avatars"),
  flow("avatars.cleanup", {
...
```typescript title="src/flows/photos/put.ts"
import { on, flow, http } from "okengine";
import { z } from "zod";
import { uploads } from "@/core";

export const putPhoto = on(
  http.post("/photos"),
  flow("photos.put", {
...
export const makeCard = on(
  http.post("/photos/card"),
  flow("photos.card", {
...
```typescript title="src/flows/notes/attach.ts"
import { on, flow, http } from "okengine";
import { z } from "zod";
import { uploads } from "@/core";

export const attachNote = on(
  http.post("/notes/:id/attachment"),
  flow("notes.attach", {
    in: z.object({
      id: z.string(),
      name: z.string().min(1),
...
```typescript title="src/flows/notes/download.ts"
import { on, flow, http } from "okengine";
import { z } from "zod";
import { uploads } from "@/core";

export const downloadAttachment = on(
  http.get("/notes/:id/attachment"),
  flow("notes.download", {
...
```typescript title="src/flows/notes/detach.ts"
import { on, flow, http } from "okengine";
import { z } from "zod";
import { uploads } from "@/core";

export const detachNote = on(
  http.delete("/notes/:id/attachment"),
  flow("notes.detach", {
    in: z.object({ id: z.string(), name: z.string() }),
    do: async ({ id, name }, fx) => {
      const key = `notes/${id}/${name}`;
...
```typescript title="src/flows/notes/attachments.ts"
import { on, flow, http } from "okengine";
import { z } from "zod";
import { uploads } from "@/core";

export const listAttachments = on(
  http.get("/notes/:id/attachments"),
  flow("notes.attachments", {
