...
offers llama.cpp · Ollama · vLLM · SGLang · cloud providers. llama.cpp and
Ollama paths: machine banner → model tier / manual (Docker Hub `ai/` vs Ollama
library). Cloud: API token → model.
