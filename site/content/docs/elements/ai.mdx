...
Prod model choice is never guessed — must be declared. Dev uses `mock` for determinism. AI + `pii` is denied unless `allowPii`.
</Callout>

## At a glance

<Cards>
  <Card title="AI" description="Essence: reaching machine intelligence. Replaces: model calls · prompts · embeddings · agents · RAG." />
</Cards>
...
<Cards>
  ...
  <Card title="declared provider" description="Prod: Anthropic · openai-compatible · Bedrock · Vertex · Ollama." />
</Cards>
