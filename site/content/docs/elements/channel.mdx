...
<Callout title="Governing rule">
  Reaching a human has physics Signal cannot express: consent, locale, receipts, and fallback
  chains.
</Callout>
...
<Cards>
  <Card
    title="Channel"
    description="Essence: reaching humans. Replaces: email · SMS · WhatsApp · push."
  />
</Cards>
...
<Callout title="Why">
  Channel is an element because human reach has irreducible physics — consent, locale, receipts —
  that machine messaging does not.
</Callout>
