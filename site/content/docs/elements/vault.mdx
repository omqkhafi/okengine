...
| Action               | Confirm                                | HTTP                                                                   |
| -------------------- | -------------------------------------- | ---------------------------------------------------------------------- |
| Add a contract       | session only                           | `POST /console/vault/create` — lists as `console` until declared in source |
| Set / rotate a value | reason (min 3)                         | `POST /console/vault/set` · `/rotate`                                  |
