...
- [HTTP](/docs/elements/flow/http) — verbs, `http.resource`, `api.live`
- [See It Work](/docs/understand/the-anatomy) — generated barrel → client → test loop
...
- [Signal](/docs/elements/signal) — `api.live` for `signal.live` SSE
