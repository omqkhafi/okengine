...
| **Reverse proxy (compose/Swarm)** | Opt-in Caddy, Traefik, or nginx (`images.proxy`)                                        | [Reverse proxy](/docs/deployment/reverse-proxy)  |
...
<Cards>
  ...
  <Card
    title="Reverse proxy"
    description="Caddy / Traefik / nginx — TLS, domains, socket-proxy why."
