...
<Callout title="The one rule">
  Open the instance → **Connections** for **Primary Endpoint** + port; **Security** for
  the AUTH string. There is no public hostname to paste.
</Callout>
...
<Cards>
  ...
  <Card title="Dragonfly Cloud" description="Public TLS endpoint option." href="/docs/providers/dragonfly-cloud" />
</Cards>
