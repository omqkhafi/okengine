...
<Callout title="The one rule">
  Build `rediss://` from **Overview** hostname + **Access keys** primary key + SSL port
  **6380**. Do not use 6379 unless you explicitly allowed non-TLS.
</Callout>
...
<Cards>
  ...
  <Card title="CockroachDB" description="Managed SQL-side pair." href="/docs/providers/cockroachdb" />
</Cards>
