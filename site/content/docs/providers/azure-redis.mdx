...
`{ durable: true }` needs a URL whose **tier actually persists**. Basic and Standard have **no**
RDB/AOF. Premium offers RDB/AOF; Enterprise persistence is preview. oke cannot enable AOF via URL.
