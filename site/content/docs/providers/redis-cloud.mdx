...
| Durable KV    | Persistence **off by default**. Free Essentials: none. Paid Essentials: AOF every 1s or snapshots. Pro: AOF every write / every 1s / snapshots. Console setting — not the URL. |
