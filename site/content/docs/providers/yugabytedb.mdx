...
<Callout title="The one rule">
  In **Connect → Connect to your Application**, choose **YSQL** and download the CA
  cert. Port **5433** is the YSQL default — not Postgres's 5432.
</Callout>
...
<Cards>
  ...
  />
  <Card title="Supabase" description="Managed single-node option." href="/docs/providers/supabase" />
  <Card
    title="Redis Cloud"
