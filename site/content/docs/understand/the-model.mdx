...
<sub>*OKE isn't an acronym for anything in the code. It comes from Omq Khafi — the organization this engine grew out of — with "Engine" appended: **O**mq **K**hafi **E**ngine.*</sub>
