...
| `/llms.mdx/docs/⟨slug⟩` | One page as source markdown                                       | One page — e.g. Vault                        |
...
HTML docs pages advertise `rel="alternate"` `type="text/markdown"` to the twin. Crawlers
that honor `robots.txt` are allowed; `/sitemap.xml` lists the handbook and the machine
entry points.
