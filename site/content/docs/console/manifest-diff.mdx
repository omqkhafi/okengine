...
<Cards>
  ...
  <Card title="Permission widening" description="Attack surface grew — gate removed or scope widened." />
  <Card title="Effect widening" description="New write, external effect, or secret read." />
  <Card title="CI gate" description="Blocks undeclared breaks; intended breaks need `breaking: true`." />
</Cards>
