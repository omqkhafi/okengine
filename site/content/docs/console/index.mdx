...
<Cards>
  <Card title="Overview" description="Is the system healthy right now?" href="/docs/console/overview" />
  <Card title="Flows" description="What exists; call it; read its contract." href="/docs/console/flows" />
  ...
  <Card title="Gates" description="Permission matrix and rate counters." href="/docs/console/gates" />
  <Card title="Vault" description="Secret contracts and rotation." href="/docs/console/vault" />
  <Card title="Channels" description="Templates, receipts, opt-outs." href="/docs/console/channels" />
  ...
  <Card title="Manifest Diff" description="Blast radius of a deploy." href="/docs/console/manifest-diff" />
  ...
  <Card title="Tenancy" description="Per-tenant usage (conditional)." href="/docs/console/tenancy" />
</Cards>
