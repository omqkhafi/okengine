...
Refuse the giant roles×permissions matrix as the entry point — inquire from principal or from flow.
</Callout>
...
<Cards>
  ...
  <Card title="Unguarded flows" description="Continuous audit: public user-plane flows after deploy." />
  <Card title="Deploy diff" description="Permission widening caught from Manifest Diff." />
  <Card title="Plane separation" description="Operator holding an application scope is a violation." />
</Cards>
