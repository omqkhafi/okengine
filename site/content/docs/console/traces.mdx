...
<Cards>
  ...
  <Card title="Filter by effect" description="Everything that wrote a table, sent mail, or cost more than X." />
  <Card title="Why slow / why fail" description="Critical path highlight; open on the failing span." />
</Cards>
