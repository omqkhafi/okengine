...
| `vault` | Secrets and config (`dotenv` local · `sops` prod) |
...
| **Vault** | secrets · config · environment (`dotenv` local · `sops` prod) |
...
4. [Notes](/docs/learn/notes) — full teaching path

<Cards>
  <Card title="Comparison" description="Positioning matrix against Hono, Elysia, Encore.ts, and iii." href="/docs/get-started/comparison" />
  <Card title="Installation" description="Install okengine and scaffold with create-oke." href="/docs/get-started/installation" />
  <Card title="Basic Usage" description="Flows, typed client, and tests from the Notes example." href="/docs/get-started/basic-usage" />
</Cards>
