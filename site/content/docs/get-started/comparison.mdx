...
OKE sits at the intersection of Encore's batteries, Elysia's DX, and Hono's portability — without adopting any one of their trade-offs (Rust lock-in, cloud gravity, or a source-available license). The matrix below makes that concrete.
...
<Cards>
  <Card title="Installation" description="Install and scaffold in minutes." href="/docs/get-started/installation" />
  <Card title="Introduction" description="The one law, eight elements, ten exports." href="/docs/get-started/introduction" />
</Cards>
