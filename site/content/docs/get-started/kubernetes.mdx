...
Compose `images.proxy` recipes are for plain Docker / Swarm — see
[Docker · Which proxy?](/docs/get-started/docker#which-proxy).
...
- [Docker](/docs/get-started/docker) — plain compose + opt-in Caddy / Traefik (non-K8s)
- [Docker Swarm](/docs/get-started/docker-swarm) — `docker stack deploy`
