...
| `fumadocs-ui`         | site                    | `npm:@fumadocs/base-ui@<ver>` | Alias to base-ui; keep in lockstep with `fumadocs-core`        |
| `fumadocs-core`       | site                    | exact or aligned with ui      | Pair with fumadocs-ui alias version                            |
...
| fumadocs-*                        | `site/package.json` still has `npm:@fumadocs/base-ui@…`; core and ui versions match |
