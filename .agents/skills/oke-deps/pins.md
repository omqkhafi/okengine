...
| --------------------- | ----------------------- | ------------------------------------- | ----------------------------------------------------------------------------------- |
| `drizzle-orm`         | root, templates, keel   | `1.0.0-rc.5-5935859` (npm `rc5`)      | Framework targets Drizzle 1 RC; npm `latest` is `0.45.x`. There is no `1.0.0-rc.5`. |
| `drizzle-kit`         | root, templates, keel   | `1.0.0-rc.5-5935859` (npm `rc5`)      | Same `rc5` hash as orm. Confirm `drizzle-kit/cli` after install.                    |
