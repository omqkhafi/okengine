...
2. **Verify the API surface from source.** Docs claims come from code, never from memory or from the old page. Sources of truth:
   ...
   - Real default configs: `packages/create-oke/templates/blank/oke.config.ts`
