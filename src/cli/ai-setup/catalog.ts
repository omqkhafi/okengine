...
export const CLOUD_PROVIDERS: readonly CloudProviderMenuEntry[] = [
  {
    ...
    baseUrl: getAiProviderEntry("openrouter")!.baseUrl,
  ...
  },
  {
    ...
    label: "OpenAI",
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("openai")!.baseUrl,
  ...
  },
  {
    ...
    label: "Groq",
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("groq")!.baseUrl,
  ...
  },
  {
    ...
    label: "Together AI",
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("together")!.baseUrl,
  ...
  },
  {
    ...
    label: "DeepSeek",
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("deepseek")!.baseUrl,
  ...
  },
  {
    ...
    label: "Mistral",
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("mistral")!.baseUrl,
  ...
  },
  {
    ...
    label: "xAI (Grok)",
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("xai")!.baseUrl,
  ...
  },
  {
    ...
    label: "DeepInfra",
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("deepinfra")!.baseUrl,
  ...
  },
  {
    ...
    driver: "openai-compatible",
    baseUrl: getAiProviderEntry("vercel")!.baseUrl,
  ...
  },
  {
    ...
    driver: "openai-compatible",
    provider: "gemini",
    baseUrl: getAiProviderEntry("gemini")!.baseUrl,
...
export function cloudApplyDefaults(
  ...
  const registry = getAiProviderEntry(provider);
  // Registry openai-compat: omit baseUrl so ai.model auto-resolves.
  const omitBase = registry !== undefined && meta.driver === "openai-compatible";
