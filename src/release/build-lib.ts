...
const ENTRIES: readonly { readonly src: string; readonly out: string }[] = [
  ...
  { src: "src/kernel/errors-text.ts", out: "dist/errors-text.js" },
  { src: "src/kernel/fx-sql-handle.ts", out: "dist/fx-sql-handle.js" },
  { src: "src/kernel/concurrency.ts", out: "dist/concurrency.js" },
  { src: "src/compiler/aot.ts", out: "dist/aot.js" },
  { src: "src/runs/window.ts", out: "dist/window.js" },
  { src: "src/okid-extended.ts", out: "dist/okid-extended.js" },
