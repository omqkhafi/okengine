...
/**
 * Gzip size of the client runtime bundle (one file, no split).
 *
 * If this build ever uses `splitting`, the gate must count the entry plus
 * every chunk it imports statically. The entry file alone under-counts the
