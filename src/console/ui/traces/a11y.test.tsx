...
import { TracesA11yView } from "./TracesA11yView.tsx";

describe("Traces panel accessibility", () => {
  let window: Window;
  let root: Root;
  ...
  beforeEach(() => {
    ...
    window = new Window({ url: "http://console.test/traces" });
  ...
  test("axe reports zero violations at WCAG 2.2 AA", async () => {
    await act(async () => {
      root.render(<TracesA11yView openRootId="run-create-ok" />);
    });
