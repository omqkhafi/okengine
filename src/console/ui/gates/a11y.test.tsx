...
import { GatesA11yView } from "./GatesA11yView.tsx";

describe("Gates panel accessibility", () => {
  let window: Window;
  let root: Root;
  ...
  test("axe reports zero violations at WCAG 2.2 AA (from flow)", async () => {
    await act(async () => {
      root.render(<GatesA11yView from="flow" openFlow="bookings.create" />);
    });
