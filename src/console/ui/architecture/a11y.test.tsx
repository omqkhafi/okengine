...
import { ArchitectureA11yView } from "./ArchitectureA11yView.tsx";

describe("Architecture panel accessibility", () => {
  let window: Window;
  let root: Root;
  ...
  beforeEach(() => {
    ...
    window = new Window({ url: "http://console.test/architecture" });
  ...
  test("axe reports zero violations at WCAG 2.2 AA", async () => {
    await act(async () => {
      root.render(<ArchitectureA11yView focus="unit:bookings" depth={1} />);
    });
