...
import { RunsA11yView } from "./RunsA11yView.tsx";

describe("Runs panel accessibility", () => {
  let window: Window;
  let root: Root;
  ...
  beforeEach(() => {
    ...
    window = new Window({ url: "http://console.test/runs" });
  ...
  test("axe reports zero violations at WCAG 2.2 AA", async () => {
    await act(async () => {
      root.render(<RunsA11yView openRunId="run-create-ok" withOutliers />);
    });
