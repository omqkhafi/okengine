...
import { OBSERVABILITY_WINDOWS, type ObservabilityWindow } from "../lib/window-stats.ts";
...
export interface HealthStripProps {
  ...
  readonly onWindowChange: (window: ObservabilityWindow) => void;
  /** Open the fleet Sheet (Instances chip). */
  readonly onInstancesClick?: () => void;
}

const WINDOW_ORDER = Object.keys(OBSERVABILITY_WINDOWS) as ObservabilityWindow[];
