...
/**
 * Renders the selected value (or a custom formatter).
 */
...
/**
 * Button that opens the select popup.
 */
function SelectTrigger({
  ...
  size?: "sm" | "default";
  /** Flush, borderless trigger — same language as Input `flat`. */
  flat?: boolean;
}) {
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        flat &&
          "rounded-none border-0 bg-transparent shadow-none hover:bg-transparent focus-visible:border-0 focus-visible:ring-0 dark:bg-transparent dark:hover:bg-transparent",
        className,
      )}
      {...props}
    >
...
/**
 * Popup list positioned relative to the trigger.
 */
...
/**
 * Scroll affordance at the top of a long select list.
 */
...
/**
 * Scroll affordance at the bottom of a long select list.
 */
