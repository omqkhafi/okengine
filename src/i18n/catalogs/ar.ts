...
export const builtinAr = {
  oke: {
    ...
    "1008": {
      cause: 'التدفق "{flow}" يجلب "{resource}" دون الإعلان عنه.',
      fix: 'أضف "{resource}" إلى effects.fetches لهذا التدفق.',
    },
    "1009": {
    ...
    "1510": {
      cause: "{count} أسرار بلا قيمة في أي طبقة حل.",
      fix: "عيّن كل اسم (`oke vault set <name>` أو `.env.local`).",
    },
  },
  errors: {
    ...
    Conflict: "هذه القيمة مستخدمة بالفعل.",
    ForeignKey: "السجل المرتبط غير موجود.",
    DatabaseError: "رفضت قاعدة البيانات هذا التغيير.",
    "DatabaseError.not_null": "حقل مطلوب مفقود.",
    "DatabaseError.check": "قيمة لم تستوفِ قيداً في قاعدة البيانات.",
    "DatabaseError.invalid": "قيمة غير صالحة لهذا العمود.",
    "DatabaseError.too_long": "القيمة أطول من المسموح لهذا العمود.",
    "DatabaseError.out_of_range": "القيمة خارج النطاق المسموح.",
    "DatabaseError.retryable": "قاعدة البيانات مشغولة. حاول بعد قليل.",
    ServiceUnavailable: "الخدمة غير متاحة مؤقتاً.",
    InternalError: "حدث خطأ. حاول مرة أخرى.",
    IdempotencyKeyMissing: "هذا الاستدعاء يتطلب ترويسة Idempotency-Key.",
    ...
    "Forbidden.invalid_key": "مفتاح الكائن هذا غير مسموح.",
